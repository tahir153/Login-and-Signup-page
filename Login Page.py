...
def login():
    ...
    login_label2 = customtkinter.CTkLabel(frame2,font=font1,text='Login', text_color='#fff',bg_color='#012200')
    ...
    password_entry2 = customtkinter.CTkEntry(frame2,font=font2,show="*",text_color='#121111',placeholder_text="Password",placeholder_text_color='#a3a3a3',width=200,height=50)
...
image2 = PhotoImage(file='1.png')
image2_label = Label(frame1, image=image2,bg="#001220")
image2_label.place(x=0,y=0)
frame1.image2 = image2
...
login_label = customtkinter.CTkLabel(frame1,font=font3,text='Already have account?',text_color='#fff',bg_color='#001220')
login_label.place(x=230,y=250)

login_button = customtkinter.CTkButton(frame1,command=login,font=font4,text_color='#00bf77',text='Login',fg_color='#001220',cursor='hand2',width=40)
